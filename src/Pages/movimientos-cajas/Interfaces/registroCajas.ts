...
export interface MovimientoCajaItem {
  ...
  actualizadoEn: string; // ISO
  banco: string | null;
  // Si quieres forzar las categorías conocidas usa `CategoriaMovimiento | null`
  // si prefieres ser flexible, usa `CategoriaMovimiento | (string & {}) | null`
  ...
  deltaCaja?: number; // para conocer el signo real
  deltaBanco?: number;
