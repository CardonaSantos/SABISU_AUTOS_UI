...
interface PropsAjuste {
  data?: PaginatedHistorialAjusteStockDTO;
  isLoading: boolean;
  currentPage: number;
  totalPages: number;
  onPageChange: (page: number) => void;
  onViewDetails: (item: HistorialAjusteStockItemDTO) => void;
}

export default function AjustesTable({
  data,
  isLoading,
  currentPage,
  totalPages,
  ...
  const items: HistorialAjusteStockItemDTO[] = data?.data ?? [];
